...
namespace Farm.Farming
{
    ...
    public static class FarmLevels
    {
        ...
        /// </para>
        /// <para>
        /// Роса в цене — то, ради чего стоит выходить ночью (правило 2 в CLAUDE.md). Честно:
        /// КУПИТЬ росу в лавке нельзя, но продать свою, подарить и выставить на рынок — можно
        /// (осознанно, социальный слой); продажа из склада переспрашивает, чтобы валюту
        /// расширения не спускали за монеты по незнанию. Числа растут медленнее золота:
        /// собирать росу руками дольше, чем зарабатывать монеты.
        /// </para>
        /// </summary>
        private static readonly Step[] Ladder =
        {
            ...
            // золота и здесь: по замеру сцены ночь даёт ~35 капель, 320 — около девяти ночей
            // присутствия (не «недели»: сутки фермы — 600 с).
