...
namespace Farm.Characters
{
    ...
    public enum ResidentRole
    {
        ...
        /// <summary>
        /// Ночной сторож: живость, не экономика — жалования не берёт, ночью ходит дозором
        /// вместо сна и отсыпается днём. Ничего не производит и не собирает (правило 2:
        /// ночь принадлежит игроку).
        /// </summary>
        Watchman = 3,

        /// <summary>Строитель: наём ставит его к стройплощадкам — покупки встают быстрее.</summary>
        Builder = 4
    }
